...
function HerokuDriver(options) {
  ...
  HerokuResource.apiUser = this._config.get('heroku:apiUser');
  HerokuResource.apiPassword = this._config.get('heroku:apiPassword');
  HerokuResource.registrationUrl = this._config.get('heroku:registrationUri');
  HerokuResource.supervisorUrl = this._config.get('heroku:supervisorUrl');
